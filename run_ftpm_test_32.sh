...
rm -f /tmp/ree_32.in /tmp/ree_32.out /tmp/tee_32.in /tmp/tee_32.out
mkfifo /tmp/ree_32.in /tmp/ree_32.out /tmp/tee_32.in /tmp/tee_32.out
...
QEMU_CMD="./qemu-system-arm \
    -nographic \
    -serial pipe:/tmp/ree_32 -serial pipe:/tmp/tee_32 \
    -smp 1 \
...
echo Attempting to connect to QEMU at /tmp/ree_32.in
echo "root" > /tmp/ree_32.in
sleep 5
